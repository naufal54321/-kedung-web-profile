...
import { FaCamera, FaChevronLeft, FaChevronRight, FaExpand } from 'react-icons/fa';
      ...
      <div className="section-card" data-aos="fade-up">
        <div className="section-header">
          ...
          <div className="photo-nav">
            <button type="button" className="photo-nav-btn" onClick={() => scrollByCard(-1)} aria-label="Geser ke kiri">
              <FaChevronLeft />
            </button>
            <button type="button" className="photo-nav-btn" onClick={() => scrollByCard(1)} aria-label="Geser ke kanan">
              <FaChevronRight />
            </button>
          </div>
        </div>
